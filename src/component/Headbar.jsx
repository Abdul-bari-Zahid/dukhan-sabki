...
//           <h4 className="font-semibold text-base md:text-lg ml-2 hover:underline">Home</h4>
//         </Link>
//         <Link to="/shop" className="hover:underline">
//           <h4 className="font-semibold text-base md:text-lg ml-2 hover:underline">Shop</h4>
//         </Link>
//       </div>
